...
# 266 "main.c"
    ...
    kp = (1.0*u16_plm)/u16_pb;
    ki = u16_ib;
    ki = 1.0/(ki*10.0);
    flt_gain1 = u16_cg1*100.0 + (u16_cg2 * 0.1) ;
    ...
    while (1)
    {
        ...
        if(TMR3_HasOverflowOccured() == 1)
        {
            ...
            flt_adcavg1 = flt_adcavg1 + ADC_GetConversion(channel_AN2);
            flt_adcavg2 = flt_adcavg2 + ADC_GetConversion(channel_AN1);
            if(uint_adccnt >= 10)
            {
...
# 601 "main.c"
            PID_error = 0.5 + (float)u16_SETtemp - flt_Temp;
            ...
            if(PID_value < 0)
            { PID_value = 0; }
            if(PID_value > u16_plm)
            { PID_value = u16_plm; }
            previous_error = PID_error;

            u8_powerduty = PID_value;
...
void sev_display1(char DD0,char DD1,char DD2,char DD3)
{
    do { LATBbits.LATB7 = 0; } while(0);do { LATBbits.LATB6 = 0; } while(0);do { LATBbits.LATB1 = 0; } while(0);do { LATBbits.LATB2 = 0; } while(0);
    do { LATBbits.LATB3 = 0; } while(0);do { LATBbits.LATB5 = 0; } while(0);do { LATBbits.LATB4 = 0; } while(0);do { LATCbits.LATC0 = 0; } while(0);
